...
public class Waypoint_Indicator_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (targetScript.enableCenteredTracking)
        {
            ...
            #region DIAMETER OPTIONS
            EditorGUI.indentLevel++;
            serializedObject.FindProperty("toggleDiameterOptions").boolValue = EditorGUILayout.Foldout(targetScript.toggleDiameterOptions, "Diameter Options", true, EditorStyles.foldout);
